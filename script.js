...
const jmeno = prompt("Prosím, vyplň tvoje křestní jméno (bez diakritiky):").trim()
const prijmeni = prompt("Prosím vyplň tvoje příjmení (bez diakritiky):").trim()

const user1 = {
  userName: prijmeni.slice(0, 3) + jmeno.slice(0, 3),
  domain: '@fit.cvut.cz',
}

document.body.innerHTML = "Vaše školní emailová adresa je: " + user1.userName.toLowerCase() + user1.domain